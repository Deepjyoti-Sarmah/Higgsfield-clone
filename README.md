...
- All 12 preset preview clips are generated by this repo (`scripts/build-preset-previews`) and served
  from our own bucket; no third-party preview media is hotlinked (see `docs/research/preview-sources.md`).
