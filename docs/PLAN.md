...
| T-041 | Create video session-history tiles: no hover state, weak active state, no scroll/focus on open | READY FOR HANDOFF (small model) | — | `docs/tasks/T-041/brief.md` |
